...
package io.github.qasecret.selenium.webdriven;

import static io.github.qasecret.selenium.qt.remote.CapabilityType.SUPPORTS_JAVASCRIPT;

import com.google.common.annotations.VisibleForTesting;

import io.github.qasecret.selenium.CommandProcessor;
import io.github.qasecret.selenium.SeleniumException;

import io.github.qasecret.selenium.qt.HasCapabilities;
import io.github.qasecret.selenium.qt.JavascriptExecutor;
import io.github.qasecret.selenium.qt.WebDriver;
import io.github.qasecret.selenium.qt.WrapsDriver;
import io.github.qasecret.selenium.webdriven.commands.AddLocationStrategy;
import io.github.qasecret.selenium.webdriven.commands.AddSelection;
import io.github.qasecret.selenium.webdriven.commands.AlertOverride;
import io.github.qasecret.selenium.webdriven.commands.AllowNativeXPath;
import io.github.qasecret.selenium.webdriven.commands.AltKeyDown;
import io.github.qasecret.selenium.webdriven.commands.AltKeyUp;
import io.github.qasecret.selenium.webdriven.commands.AnswerOnNextPrompt;
import io.github.qasecret.selenium.webdriven.commands.AssignId;
import io.github.qasecret.selenium.webdriven.commands.AttachFile;
import io.github.qasecret.selenium.webdriven.commands.CaptureScreenshotToString;
import io.github.qasecret.selenium.webdriven.commands.Check;
import io.github.qasecret.selenium.webdriven.commands.Click;
import io.github.qasecret.selenium.webdriven.commands.ClickAt;
import io.github.qasecret.selenium.webdriven.commands.Close;
import io.github.qasecret.selenium.webdriven.commands.ControlKeyDown;
import io.github.qasecret.selenium.webdriven.commands.ControlKeyUp;
import io.github.qasecret.selenium.webdriven.commands.CreateCookie;
import io.github.qasecret.selenium.webdriven.commands.DeleteAllVisibleCookies;
import io.github.qasecret.selenium.webdriven.commands.DeleteCookie;
import io.github.qasecret.selenium.webdriven.commands.DeselectPopUp;
import io.github.qasecret.selenium.webdriven.commands.DoubleClick;
import io.github.qasecret.selenium.webdriven.commands.DragAndDrop;
import io.github.qasecret.selenium.webdriven.commands.DragAndDropToObject;
import io.github.qasecret.selenium.webdriven.commands.FindFirstSelectedOptionProperty;
import io.github.qasecret.selenium.webdriven.commands.FindSelectedOptionProperties;
import io.github.qasecret.selenium.webdriven.commands.FireEvent;
import io.github.qasecret.selenium.webdriven.commands.FireNamedEvent;
import io.github.qasecret.selenium.webdriven.commands.GetAlert;
import io.github.qasecret.selenium.webdriven.commands.GetAllButtons;
import io.github.qasecret.selenium.webdriven.commands.GetAllFields;
import io.github.qasecret.selenium.webdriven.commands.GetAllLinks;
import io.github.qasecret.selenium.webdriven.commands.GetAllWindowNames;
import io.github.qasecret.selenium.webdriven.commands.GetAllWindowTitles;
import io.github.qasecret.selenium.webdriven.commands.GetAttribute;
import io.github.qasecret.selenium.webdriven.commands.GetAttributeFromAllWindows;
import io.github.qasecret.selenium.webdriven.commands.GetBodyText;
import io.github.qasecret.selenium.webdriven.commands.GetConfirmation;
import io.github.qasecret.selenium.webdriven.commands.GetCookie;
import io.github.qasecret.selenium.webdriven.commands.GetCookieByName;
import io.github.qasecret.selenium.webdriven.commands.GetCssCount;
import io.github.qasecret.selenium.webdriven.commands.GetCursorPosition;
import io.github.qasecret.selenium.webdriven.commands.GetElementHeight;
import io.github.qasecret.selenium.webdriven.commands.GetElementIndex;
import io.github.qasecret.selenium.webdriven.commands.GetElementPositionLeft;
import io.github.qasecret.selenium.webdriven.commands.GetElementPositionTop;
import io.github.qasecret.selenium.webdriven.commands.GetElementWidth;
import io.github.qasecret.selenium.webdriven.commands.GetEval;
import io.github.qasecret.selenium.webdriven.commands.GetExpression;
import io.github.qasecret.selenium.webdriven.commands.GetHtmlSource;
import io.github.qasecret.selenium.webdriven.commands.GetLocation;
import io.github.qasecret.selenium.webdriven.commands.GetSelectOptions;
import io.github.qasecret.selenium.webdriven.commands.GetTable;
import io.github.qasecret.selenium.webdriven.commands.GetText;
import io.github.qasecret.selenium.webdriven.commands.GetTitle;
import io.github.qasecret.selenium.webdriven.commands.GetValue;
import io.github.qasecret.selenium.webdriven.commands.GetXpathCount;
import io.github.qasecret.selenium.webdriven.commands.GoBack;
import io.github.qasecret.selenium.webdriven.commands.Highlight;
import io.github.qasecret.selenium.webdriven.commands.IsAlertPresent;
import io.github.qasecret.selenium.webdriven.commands.IsChecked;
import io.github.qasecret.selenium.webdriven.commands.IsConfirmationPresent;
import io.github.qasecret.selenium.webdriven.commands.IsCookiePresent;
import io.github.qasecret.selenium.webdriven.commands.IsEditable;
import io.github.qasecret.selenium.webdriven.commands.IsElementPresent;
import io.github.qasecret.selenium.webdriven.commands.IsOrdered;
import io.github.qasecret.selenium.webdriven.commands.IsPromptPresent;
import io.github.qasecret.selenium.webdriven.commands.IsSomethingSelected;
import io.github.qasecret.selenium.webdriven.commands.IsTextPresent;
import io.github.qasecret.selenium.webdriven.commands.IsVisible;
import io.github.qasecret.selenium.webdriven.commands.KeyDownNative;
import io.github.qasecret.selenium.webdriven.commands.KeyEvent;
import io.github.qasecret.selenium.webdriven.commands.KeyPressNative;
import io.github.qasecret.selenium.webdriven.commands.KeyState;
import io.github.qasecret.selenium.webdriven.commands.KeyUpNative;
import io.github.qasecret.selenium.webdriven.commands.MetaKeyDown;
import io.github.qasecret.selenium.webdriven.commands.MetaKeyUp;
import io.github.qasecret.selenium.webdriven.commands.MouseEvent;
import io.github.qasecret.selenium.webdriven.commands.MouseEventAt;
import io.github.qasecret.selenium.webdriven.commands.NoOp;
import io.github.qasecret.selenium.webdriven.commands.Open;
import io.github.qasecret.selenium.webdriven.commands.OpenWindow;
import io.github.qasecret.selenium.webdriven.commands.Refresh;
import io.github.qasecret.selenium.webdriven.commands.RemoveAllSelections;
import io.github.qasecret.selenium.webdriven.commands.RemoveSelection;
import io.github.qasecret.selenium.webdriven.commands.RunScript;
import io.github.qasecret.selenium.webdriven.commands.SelectFrame;
import io.github.qasecret.selenium.webdriven.commands.SelectOption;
import io.github.qasecret.selenium.webdriven.commands.SelectPopUp;
import io.github.qasecret.selenium.webdriven.commands.SelectWindow;
import io.github.qasecret.selenium.webdriven.commands.SetCursorPosition;
import io.github.qasecret.selenium.webdriven.commands.SetNextConfirmationState;
import io.github.qasecret.selenium.webdriven.commands.SetTimeout;
import io.github.qasecret.selenium.webdriven.commands.ShiftKeyDown;
import io.github.qasecret.selenium.webdriven.commands.ShiftKeyUp;
import io.github.qasecret.selenium.webdriven.commands.Submit;
import io.github.qasecret.selenium.webdriven.commands.Type;
import io.github.qasecret.selenium.webdriven.commands.TypeKeys;
import io.github.qasecret.selenium.webdriven.commands.Uncheck;
import io.github.qasecret.selenium.webdriven.commands.UseXPathLibrary;
import io.github.qasecret.selenium.webdriven.commands.WaitForCondition;
import io.github.qasecret.selenium.webdriven.commands.WaitForPageToLoad;
import io.github.qasecret.selenium.webdriven.commands.WaitForPopup;
import io.github.qasecret.selenium.webdriven.commands.WindowFocus;
import io.github.qasecret.selenium.webdriven.commands.WindowMaximize;
