...
public interface Keyboard {
   ...
   *
   * Special keys that are not text, represented as {@link Keys} are recognized
  ...
  /**
   * Press a key on the keyboard that isn't text.  Please see {@link Keys} for
  ...
  /**
   * Release a key on the keyboard that isn't text.  Please see {@link Keys} for
   * an exhaustive list of recognized pressable keys.
   *
