...
public interface WebDriverEventListener {
  ...
  /**
   * Called before {@link RemoteWebDriver#executeScript(java.lang.String, java.lang.Object[]) }
   *
   * @param driver WebDriver
  ...
  /**
   * Called after {@link RemoteWebDriver#executeScript(java.lang.String, java.lang.Object[]) }.
  ...
  /**
   * This action will be performed each time before  {@link WebDriver.TargetLocator#window(java.lang.String)}
   *
   * @param driver WebDriver
   */
  ...
  /**
   * This action will be performed each time after  {@link WebDriver.TargetLocator#window(java.lang.String)}
   *
   * @param driver WebDriver
   */
