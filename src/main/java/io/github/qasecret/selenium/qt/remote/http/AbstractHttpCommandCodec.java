...
package io.github.qasecret.selenium.qt.remote.http;
...
import static io.github.qasecret.selenium.qt.json.Json.MAP_TYPE;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.ADD_COOKIE;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.CLEAR_ELEMENT;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.CLICK_ELEMENT;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.CLOSE;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.DELETE_ALL_COOKIES;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.DELETE_COOKIE;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.ELEMENT_EQUALS;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.ELEMENT_SCREENSHOT;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.FIND_CHILD_ELEMENT;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.FIND_CHILD_ELEMENTS;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.FIND_ELEMENT;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.FIND_ELEMENTS;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.FULLSCREEN_CURRENT_WINDOW;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.GET;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.GET_ALL_COOKIES;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.GET_ALL_SESSIONS;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.GET_APP_CACHE_STATUS;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.GET_AVAILABLE_LOG_TYPES;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.GET_CAPABILITIES;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.GET_CONTEXT_HANDLES;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.GET_COOKIE;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.GET_CURRENT_CONTEXT_HANDLE;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.GET_CURRENT_URL;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.GET_ELEMENT_LOCATION;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.GET_ELEMENT_PROPERTY;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.GET_ELEMENT_RECT;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.GET_ELEMENT_SIZE;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.GET_ELEMENT_TAG_NAME;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.GET_ELEMENT_TEXT;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.GET_ELEMENT_VALUE_OF_CSS_PROPERTY;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.GET_LOCATION;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.GET_LOG;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.GET_NETWORK_CONNECTION;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.GET_SCREEN_ORIENTATION;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.GET_SCREEN_ROTATION;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.GET_SESSION_LOGS;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.GET_TITLE;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.GO_BACK;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.GO_FORWARD;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.IME_ACTIVATE_ENGINE;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.IME_DEACTIVATE;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.IME_GET_ACTIVE_ENGINE;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.IME_GET_AVAILABLE_ENGINES;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.IME_IS_ACTIVATED;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.IMPLICITLY_WAIT;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.IS_BROWSER_ONLINE;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.IS_ELEMENT_ENABLED;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.IS_ELEMENT_SELECTED;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.NEW_SESSION;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.QUIT;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.REFRESH;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.SCREENSHOT;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.SEND_KEYS_TO_ELEMENT;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.SET_ALERT_CREDENTIALS;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.SET_BROWSER_ONLINE;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.SET_LOCATION;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.SET_NETWORK_CONNECTION;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.SET_SCREEN_ORIENTATION;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.SET_SCREEN_ROTATION;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.SET_SCRIPT_TIMEOUT;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.SET_TIMEOUT;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.STATUS;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.SWITCH_TO_CONTEXT;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.SWITCH_TO_FRAME;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.SWITCH_TO_PARENT_FRAME;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.SWITCH_TO_WINDOW;
import static io.github.qasecret.selenium.qt.remote.DriverCommand.UPLOAD_FILE;
...
import io.github.qasecret.selenium.qt.UnsupportedCommandException;
import io.github.qasecret.selenium.qt.json.Json;
import io.github.qasecret.selenium.qt.net.Urls;
import io.github.qasecret.selenium.qt.remote.Command;
import io.github.qasecret.selenium.qt.remote.CommandCodec;
import io.github.qasecret.selenium.qt.remote.SessionId;
