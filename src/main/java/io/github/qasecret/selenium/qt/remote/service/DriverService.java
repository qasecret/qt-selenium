...
package io.github.qasecret.selenium.qt.remote.service;
...
import io.github.qasecret.selenium.qt.net.PortProber;
...
public class DriverService {
 ...
 protected URL getUrl(int port) throws IOException {
  ...
  public static abstract class Builder<DS extends DriverService, B extends Builder<?, ?>> {
     ...
     * support instances of {@link WebDriver} that require {@code capabilities}.
