...
import static io.github.qasecret.selenium.qt.remote.http.HttpMethod.POST;
...
import io.github.qasecret.selenium.qt.remote.http.W3CHttpCommandCodec;
import io.github.qasecret.selenium.qt.remote.http.W3CHttpResponseCodec;
 ...
 * don't care which), but where either browser will use the given {@link Proxy}.
