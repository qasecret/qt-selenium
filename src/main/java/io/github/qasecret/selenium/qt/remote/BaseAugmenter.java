...
import static io.github.qasecret.selenium.qt.remote.CapabilityType.HAS_TOUCHSCREEN;
import static io.github.qasecret.selenium.qt.remote.CapabilityType.ROTATABLE;
import static io.github.qasecret.selenium.qt.remote.CapabilityType.SUPPORTS_APPLICATION_CACHE;
import static io.github.qasecret.selenium.qt.remote.CapabilityType.SUPPORTS_FINDING_BY_CSS;
import static io.github.qasecret.selenium.qt.remote.CapabilityType.SUPPORTS_LOCATION_CONTEXT;
import static io.github.qasecret.selenium.qt.remote.CapabilityType.SUPPORTS_NETWORK_CONNECTION;
import static io.github.qasecret.selenium.qt.remote.CapabilityType.SUPPORTS_WEB_STORAGE;
...
import io.github.qasecret.selenium.qt.remote.html5.AddApplicationCache;
import io.github.qasecret.selenium.qt.remote.html5.AddLocationContext;
import io.github.qasecret.selenium.qt.remote.html5.AddWebStorage;
import io.github.qasecret.selenium.qt.remote.mobile.AddNetworkConnection;
 ...
 * {@link RemoteWebDriver} based on the returned
 * {@link Capabilities} of the driver.
 *
...
public abstract class BaseAugmenter {
   ...
   * {@link FindsByCssSelector}, which is implemented via the
