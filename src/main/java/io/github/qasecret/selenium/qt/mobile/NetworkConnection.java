...
package io.github.qasecret.selenium.qt.mobile;
...
public interface NetworkConnection {
   ...
   *
   * @return {@link NetworkConnection.ConnectionType} indicating if the
   ...
   * @return {@link NetworkConnection.ConnectionType} of what the
